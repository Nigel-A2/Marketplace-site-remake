 ...
 * 
 * This override changes the prompt for the bank IBAN field to avoid confusing users
 */
?>
...
<div class="dokan-bank-settings-template">
    ...
    <div class="dokan-form-group">
        <div>
            <label><?php esc_html_e( 'Bank IBAN (Not all countries use IBAN, please check your bank account)', 'dokan-lite' ); ?> </label>
        </div>
